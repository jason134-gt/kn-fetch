...
public class Companyprofile0291DataService extends ImportDataBaseService{

	private static Companyprofile0291DataService instance = new Companyprofile0291DataService();
...
//	String pwd = "yangzhen";
//	Connection con ;
	private Companyprofile0291DataService() {
		try {
...
//			con = DriverManager.getConnection(jdbcurl, user, pwd);
	...
	public static Companyprofile0291DataService getInstance() {
		return instance;
	}


	public String update(Companyprofile0291 vo) {
		// TODO Auto-generated method stub
		String sqlMapKey = "com.yz.stock.portal.model.Companyprofile0291.update";
	...
	// 通过机构id查询
	public Companyprofile0291 queryBySecid(Companyprofile0291 vo) {
		String sqlMapKey = "com.yz.stock.portal.model.Companyprofile0291.getObOrgid0291";
		RequestMessage req = DAFFactory.buildRequest(
				sqlMapKey, vo, StockConstants.common);
		Object o = pLayerEnter.queryForObject(req);
		if (o == null)
			return null;
		return (Companyprofile0291) o;

	}

	public String insert(Companyprofile0291 vo) {
		// TODO Auto-generated method stub
		Companyprofile0291 csi = queryBySecid(vo);
		if (csi != null) {
			//如果相同，就无需更新
		...
		String sqlMapKey = "com.yz.stock.portal.model.Companyprofile0291.insert";
		RequestMessage req = DAFFactory.buildRequest(sqlMapKey, vo,
				StockConstants.common);
		String ret =  pLayerEnter.insert(req);
		if(!StockCodes.SUCCESS.equals(ret))
			DCenterUtil.removeFromBloomFilter(StockUtil.getBaseVoBFKey(vo.getKey(),StockConstants.TABLE_NAME_tb_company_profile_0291));
		return ret;
	}

	public String updateByCode(Companyprofile0291 vo) {
		// TODO Auto-generated method stub
		String sqlMapKey = "com.yz.stock.portal.model.Companyprofile0291.updateByCode";
		RequestMessage req = DAFFactory.buildRequest(sqlMapKey, vo,
				StockConstants.common);
		return pLayerEnter.modify(req);
	}

	public String insertRedirect(Companyprofile0291 vo) {
		String sqlMapKey = "com.yz.stock.portal.model.Companyprofile0291.insert";
		RequestMessage req = DAFFactory.buildRequest(sqlMapKey, vo,
				StockConstants.common);
	...
	public List queryCompanyprofile0291List(String obSecid0007) {
		Companyprofile0291 vo = new Companyprofile0291();
		vo.setObOrgid0291(obSecid0007);
		String sqlMapKey = "com.yz.stock.portal.model.Companyprofile0291.queryCompanyprofile0291ListByOrgid";
		RequestMessage req = DAFFactory.buildRequest(
				sqlMapKey, vo, StockConstants.common);
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public List queryProfile0291ListByCompanycode(String companycode) {
		Profile0291 vo = new Profile0291();
		vo.setcompanycode(companycode);
		String sqlMapKey = "queryProfile0291ListByCompanycode";
		RequestMessage req = DAFFactory.buildRequest(
				sqlMapKey, vo, StockConstants.common);
		Object o = pLayerEnter.queryForList(req);
		if (o == null)
...
//			Connection con = DriverManager.getConnection(jdbcurl, user, pwd);
			...
			try {
				...
				for (int x = 0; x < ul.size(); x++) {
					Companyprofile0291 v = (Companyprofile0291) ul.get(x);
...
//					mypool.freeConnection(con);
	...
	private void handlerFailure(List<Object> ul) {
		...
		try {
			for (Object o : ul) {
				Companyprofile0291 v = (Companyprofile0291) o;
				try {
					insert(v);
				} catch (Exception e) {
					logger.error("handle failed! Companyprofile0291 :" + v,e);
				}
			}
		} catch (Exception e) {
	...
	public List doLoadTableKeyList(String tableName, int start,int limit) {
		 IOperator dbOpt = new DBDefaultDaoImpl();
			...
			RequestMessage req = DAFFactory.buildRequest("com.yz.stock.portal.model.Companyprofile0291.doLoadTableKeyList", m,
					StockConstants.common);
