...
(function ($) {
	...
	$.jqPagination = function (el, options) {
		...
		base.init = function () {
			...
			base.$input.bind('focus.jqPagination mouseup.jqPagination', function (event) {
			...
			base.$input.bind('blur.jqPagination keydown.jqPagination', function (event) {
			...
			base.$el.delegate('a','click.jqPagination', function (event) {
