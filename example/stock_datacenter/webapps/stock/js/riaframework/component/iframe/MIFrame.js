...
Ext.ux.ManagedIFrame = function(){
    ...
    el.loadMask = Ext.apply({msg:'正在加载内容...',msgCls:'x-mask-loading',maskEl:null, enabled:!!config.loadMask},config.loadMask);
...
Ext.extend(Ext.ux.ManagedIFrame , Ext.util.Observable,
    ...
    */
    ...
    ,loadMask: {msg:'正在加载内容...',msgCls:'x-mask-loading',maskEl:null, enabled:false}
 ...
 */
 Ext.ux.ManagedIframePanel = Ext.extend(Ext.Panel, {
    ...
    * Note:  invoke the function with no arguments to refresh the iframe based on the current defaultSrc value.
    */
    setSrc : function(url, discardUrl,isSaveState){
...
//}
//ConvertMgr.regConverter("iframepanel",ConvertIFramePanel);
//
//ConvertIFramePortlet=function(o){
//    ConvertIFramePanel(o);
//    if(o.tools){
//        o.tools.push({id:'close',handler: function(e, target, panel){
//            panel.ownerCt.remove(panel, true);
//        }});
//    }else{
//        o.tools=[{id:'close',handler: function(e, target, panel){
//            panel.ownerCt.remove(panel, true);
//        }}];
//    }    
//    if(!o.title){
...
//    }    
//}
//ConvertMgr.regConverter("iframeportlet",ConvertIFramePortlet);
