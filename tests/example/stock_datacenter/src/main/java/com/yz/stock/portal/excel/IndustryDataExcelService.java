...
public class IndustryDataExcelService {

	Logger logger = LoggerFactory.getLogger(this.getClass());
	private static IndustryDataExcelService instance = new IndustryDataExcelService();
	IndustryDataExcelService() {

	}

	public static IndustryDataExcelService getInstance() {
		return instance;
	}
